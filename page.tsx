...
const Home = () => {
 ...
 <main className=" h-screen w-full  bg-[url('/images/grid.svg')]  bg-repeat  bg-[#3c3f40] mb-10 grid grid-cols-[1fr_1fr_1fr] grid-rows-[85vh_20vh_20vh_50vh] md:grid-cols-5 md:grid-rows-[89vh_20<vh_45vh_60vh_50vh] lg:grid-cols-8 lg:grid-rows-[25vh_60vh_45vh_25vh_50vh] xl:grid-cols-12 xl:grid-row-[25vh_66vh_30vh_25vh_25vh] gap-3">
 <section className="col-start-1 col-end-4 row-start-1 row-end-2 md:col-start-1 md:col-end-4  md:row-start-1 md:row-end-2  md:h-auto lg:w-full lg:col-start-1 lg:col-end-13">
      <div className="bg-[url('/images/sideboardobg.png')] bg-contain bg-no-repeat bg-bottom grid gap-y-1 grid-cols-[1fr_1fr_1fr] grid-rows-[34vh_18vh_4vh_10vh] md:grid-cols-[26vw_20vw_20vw_20vw_20vw] md:grid-rows-[24vw_38vh_33vh_20vh]">
          <div className="p-3 col-start-1 col-end-4 5row-start-1 row-end-2 bg-gradient-to-b to-[#3c3f40] md:bg-gradient-to-b from-blue-600/30 md:col-start-1 md:col-end-6 md:row-start-1 md:row-end-2 lg:bg-gradient-to-b from-amber-500/70">
